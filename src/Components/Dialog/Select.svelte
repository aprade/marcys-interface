    ...
    <div transition:slide class="dialog-select">
      <div class="dialog-header">
        ...
        <div class="close-btn" on:click={close}>
            <svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.75 0.75L8.25 8.25M0.75 8.25L8.25 0.75L0.75 8.25Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>                
        </div>
      </div>
      ...
      <div class="items">
          {#each $machines as mach, index}
            <div class="item" on:click={() => {machine.update(_ => mach); close();}}>
                <span>
                    {mach}
                    {#if mach === $machine}
